...
local extended_euclidean_algorithm = function(index)
	return f(function(indput)
		...
		while r ~= 0 do
			...
			if r ~= 0 then
				latex = latex ..
						"$$" .. quotient * old_r + r .. "=" .. quotient .. "*" .. old_r .. "+" .. r .. "\\qand " .. "s=" ..
						precal_old_s ..
						"-" ..
						quotient ..
						"*" .. precal_s .. "\\qand " .. "t=" .. precal_old_t .. "-" .. quotient .. "*" .. precal_t .. "$$"
			else
				latex = latex .. "$$" .. quotient * old_r + r .. "=" ..
						quotient ..
						"*" .. old_r .. "+" .. r .. "\\qand " .. "s=" .. precal_s .. "\\qand " .. "t=" .. precal_t .. "$$"
			end
		end
...
\label{{{}}}
\citep{{{}}}
\end{{figure}}]], { i(1, "x.png"), i(2), i(3, "fig:x"), i(4) })),
